...
;(function($) {
  ...
  Sequence.prototype = {
    ...
    */
    ...
    next: function() {
      var self = this;
      var id = (self.currentFrameID !== self.numberOfFrames) ? self.currentFrameID + 1 : 1; //work out the next frame ID
    ...
    prev: function() {
      var self = this;
      var id = (self.currentFrameID === 1) ? self.numberOfFrames : self.currentFrameID - 1; //work out the prev frame ID
      if(self.active === false || self.active === undefined) { //if Sequence isn't currently animating...
